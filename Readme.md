...
## How to talk to us ?
We use [Gitter Channel](https://gitter.im/Sugar-Labs) and mailing list [sugar-devel@](http://lists.sugarlabs.org/listinfo/sugar-devel) for communication. You can join our Gitter Room to participate in the discussions and asking for help. You should also subscribe to our mailing list.
